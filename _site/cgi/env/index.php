...
<head>
  ...
  <link rel="canonical" href="https://xw3.org/cgi/env/">
...
<div class="post">
  <header class="post-header">
    <h1 class="post-title" id="terminal">xw3.org:/cgi/env/</h1>
    
    <p>/cgi is a language independent scripts directory like a <a href="https://en.wikipedia.org/wiki/Common_Gateway_Interface" class="ext">/cgi-bin</a>. It must be configured in your server configuration which language files can be executed. Binaries will work too... For now it all is a little magic to me, but I will tell you how it works for me some day... ;)</p>
  </header>
...
<footer class="site-footer">
  <div class="wrapper">
    <div class="footer-col-wrapper">
      <p style="text-align:center;">
        ...
        <a href="https://git.xw3.org/xw3" class="git"><i class="fa fa-git" aria-hidden="true"></i><span style="display:none;"> Git repositories</span></a> -
  ...
  <a href="#top" id="topbutton"><span></span></a>
  <script src="/js/cookieconsent.min.js" data-cfasync="false"></script>
  <!-- Source for configuration below: https://www.osano.com/cookieconsent/download/ - https://www.osano.com/cookieconsent/documentation/compliance/ -->
