...
noDate: true
title: /cgi/env/
subtitle: /cgi is a language independent scripts directory like a <a href="https://en.wikipedia.org/wiki/Common_Gateway_Interface" class="ext">/cgi-bin</a>. It must be configured in your server configuration which language files can be executed. Binaries will work too... For now it all is a little magic to me, but I will tell you how it works for me some day... ;)
permalink: /cgi/env/
tags:
- env
- environment
